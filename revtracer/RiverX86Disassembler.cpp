...
const WORD specTbl[2][0x100] = {
		{
			...
			/*0x50*/ RIVER_SPEC_MODIFIES_OP2 | RIVER_SPEC_MODIFIES_OP3 | RIVER_SPEC_IGNORES_FLG,
			/*0x51*/ RIVER_SPEC_MODIFIES_OP2 | RIVER_SPEC_MODIFIES_OP3 | RIVER_SPEC_IGNORES_FLG,
			/*0x52*/ RIVER_SPEC_MODIFIES_OP2 | RIVER_SPEC_MODIFIES_OP3 | RIVER_SPEC_IGNORES_FLG,
			/*0x53*/ RIVER_SPEC_MODIFIES_OP2 | RIVER_SPEC_MODIFIES_OP3 | RIVER_SPEC_IGNORES_FLG,
			/*0x54*/ RIVER_SPEC_MODIFIES_OP2 | RIVER_SPEC_MODIFIES_OP3 | RIVER_SPEC_IGNORES_FLG,
			/*0x55*/ RIVER_SPEC_MODIFIES_OP2 | RIVER_SPEC_MODIFIES_OP3 | RIVER_SPEC_IGNORES_FLG,
			/*0x56*/ RIVER_SPEC_MODIFIES_OP2 | RIVER_SPEC_MODIFIES_OP3 | RIVER_SPEC_IGNORES_FLG,
			/*0x57*/ RIVER_SPEC_MODIFIES_OP2 | RIVER_SPEC_MODIFIES_OP3 | RIVER_SPEC_IGNORES_FLG,
			...
			/*0x66*/ 0,
			/*0x67*/ 0,
			/*0x68*/ RIVER_SPEC_MODIFIES_OP2 | RIVER_SPEC_MODIFIES_OP3,
			/*0x69*/ RIVER_SPEC_MODIFIES_OP1 | RIVER_SPEC_MODIFIES_FLG,
			/*0x6A*/ RIVER_SPEC_MODIFIES_OP2 | RIVER_SPEC_MODIFIES_OP3,
			...
			/*0xE6*/ 0xFF,
			/*0xE7*/ 0xFF,
			/*0xE8*/ RIVER_SPEC_MODIFIES_OP3 | RIVER_SPEC_MODIFIES_OP4,
			/*0xE9*/ 0,
			/*0xEA*/ 0,
			/*0xEB*/ 0,
			/*0xEC*/ 0xFF,
...
const WORD _specTblExt[][8] = {
		...
		/* for 0xFF    */{ 
			...
			RIVER_SPEC_MODIFIES_OP1 | RIVER_SPEC_MODIFIES_FLG, 
			RIVER_SPEC_MODIFIES_OP3 | RIVER_SPEC_MODIFIES_OP4,
			0,
			0, 
			0, 
			RIVER_SPEC_MODIFIES_OP2 | RIVER_SPEC_MODIFIES_OP3,
			0 
		},
