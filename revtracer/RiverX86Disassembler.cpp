...
void RiverX86Disassembler::DisassembleModRMSreg(rev::BYTE *&px86, RiverInstruction &ri) {
	BYTE sec;
	DisassembleModRMOp(0, px86, ri, sec);
	DisassembleRegOp(1, ri, RIVER_REG_SEGMENT + sec);
}
...
const WORD specTbl[2][0x100] = {
		{
			...
			/*0x8C*/ RIVER_SPEC_MODIFIES_OP1 | RIVER_SPEC_IGNORES_OP1,
			/*0x8D*/ RIVER_SPEC_MODIFIES_OP1 | RIVER_SPEC_IGNORES_FLG | RIVER_SPEC_IGNORES_OP1 | RIVER_SPEC_IGNORES_MEMORY,
			/*0x8E*/ 0xFF,
			/*0x8F*/ RIVER_SPEC_MODIFIES_OP1 | RIVER_SPEC_MODIFIES_OP2 | RIVER_SPEC_IGNORES_FLG | RIVER_SPEC_IGNORES_OP1,
			...
			/*0x9A*/ 0xFF,
			/*0x9B*/ 0xFF,
			/*0x9C*/ RIVER_SPEC_MODIFIES_OP1 | RIVER_SPEC_MODIFIES_OP2 | RIVER_SPEC_IGNORES_FLG | RIVER_SPEC_IGNORES_OP2,
			/*0x9D*/ 0xFF,
			/*0x9E*/ 0xFF,
			/*0x9F*/ 0xFF,
