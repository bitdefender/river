...
extern "C" void ConvertRiverInstruction(struct _exec_env *pEnv, struct RiverInstruction *ri, BYTE **px86, DWORD *pFlags) {
	...
	translateRiverTable[ri->opCode](pEnv, ri, px86, pFlags);
	translateRiverOperands[ri->opCode](pEnv, ri, px86);
...
const TranslateOpcodeFunc RiverOpcodeTable00[] = {
	...
	/*0x80*/ TranslateUnknownInstr, TranslateUnknownInstr, TranslateUnknownInstr, TranslateDefaultInstr,
...
const TranslateOperandsFunc RiverOperandsTable00[] = {
	...
	/*0x80*/ TranslateUnknownOp, TranslateUnknownOp, TranslateUnknownOp, TranslateSubOpModRMImm8Op,
