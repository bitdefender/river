...
#define REQUEST_EXECUTION_CONTORL			0x92
#define REQUEST_SYSCALL_CONTROL				0x93
...
#define REPLY_EXECUTION_CONTORL				0xD2
#define REPLY_SYSCALL_CONTROL				0xD3
