...
dockspawn.PanelContainer.prototype._initialize = function()
{
    ...
    this.elementButtonClose.innerHTML = '<i class="fa fa-close"></i>';
...
dockspawn.PanelContainer.prototype._setPanelDimensions = function(width, height)
{
    ...
    if ("function" === typeof this.elementContent.onresize) {
        this.elementContent.onresize.apply(this.elementContent);
    }
};
